...
export default function PDFAnalyzer() {
  ...
  return (
    <div className="max-h-[100dvh] w-full flex gap-4 p-4">
      {/* PDF Extractor - Fixed width, pinned to left */}
      <div className="w-[400px] flex-shrink-0 border border-zinc-150 rounded-xl">
        <PDFExtractor 
      ...
      <div className="flex-grow h-[calc(100vh-2rem)] border border-zinc-200 overflow-hidden rounded-xl">
        <MindMap 
          data={mindMapData} 
